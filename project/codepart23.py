...
# Create feature extractor using early layer
middle_layer_name = 'conv3_block2_3_conv'
feature_extractor = models.Model(
    inputs=base_model.input,
    outputs=base_model.get_layer(middle_layer_name).output
)
feature_extractor.trainable = False

# Update the model definition to use the feature extractor
